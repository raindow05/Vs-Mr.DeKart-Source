function onCreate()
  ...
  addLuaSprite('list');
	...
	makeLuaText('song', 'Old Not So Fast', '-400', -400, 325);
	setTextSize('song', 44);
  ...
  makeLuaText('author', 'By: LICOMBA x MGTV', '-500', -500, 385);
...
function onTimerCompleted(tag, loops, loopsLeft)
  if tag == 'HIlist' then
    ...
    doTweenX('SongX', 'song', 110, 1.0, 'circOut');
    doTweenX('AuthorX', 'author', 58, 1.0, 'circOut');
    runTimer('BYElist', 2)
