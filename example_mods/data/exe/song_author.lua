function onCreate()
  ...
  addLuaSprite('list');
	...
	makeLuaText('song', 'EXE', '-400', -400, 325);
	setTextSize('song', 44);
  ...
  makeLuaText('author', 'By: DanlyDaMusiciant', '-500', -500, 385);
...
function onTimerCompleted(tag, loops, loopsLeft)
  if tag == 'HIlist' then
    ...
    doTweenX('SongX', 'song', 200, 1.0, 'circOut');
    doTweenX('AuthorX', 'author', 51, 1.0, 'circOut');
    runTimer('BYElist', 2)
