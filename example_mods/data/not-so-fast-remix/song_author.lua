function onCreate()
  ...
  addLuaSprite('list');
	...
	makeLuaText('song', 'Not So Fast Remix', '-400', -400, 325);
	setTextSize('song', 34);
  ...
  makeLuaText('author', 'By: MGTV', '-500', -500, 385);
...
function onTimerCompleted(tag, loops, loopsLeft)
  if tag == 'HIlist' then
    ...
    doTweenX('SongX', 'song', 79, 1.0, 'circOut');
    doTweenX('AuthorX', 'author', 160, 1.0, 'circOut');
    runTimer('BYElist', 2)
