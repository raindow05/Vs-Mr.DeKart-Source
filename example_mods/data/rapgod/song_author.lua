function onCreate()
  ...
  addLuaSprite('list');
	...
	makeLuaText('song', 'Rapgod', '-400', -400, 325);
	setTextSize('song', 44);
  ...
  makeLuaText('author', 'Cover By: DeKart', '-500', -500, 385);
...
function onTimerCompleted(tag, loops, loopsLeft)
  if tag == 'HIlist' then
    ...
    doTweenX('SongX', 'song', 150, 1.0, 'circOut');
    doTweenX('AuthorX', 'author', 90, 1.0, 'circOut');
    runTimer('BYElist', 2)
